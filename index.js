...
ANSWER: yes, have a temp variable to store each number in while looping through the array and then multiply it by itself.
...
ANSWER: per solution file, "Each function is dependent on the size of the string"
